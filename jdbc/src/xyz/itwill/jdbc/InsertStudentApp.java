...
public class InsertStudentApp {
	public static void main(String[] args) {
		...
		try {
			...
			// http://www.itwill.xyz:80/test/index.html
			...
			// String sql="insert into student values(1000,'홍길동','010-1234-5678','서울시
			// 강남구','00/01/01')";
			// String sql="insert into student values(2000,'임꺽정','010-7894-5612','수원시
			// 월정구','02/05/08')";
