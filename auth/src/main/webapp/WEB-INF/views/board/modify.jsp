...
<body>
	...
	<form action="<c:url value="/board/modify"/>" method="post" id="modifyForm">
		<sec:csrfInput />
		<input type="hidden" name="pageNum" value="${search.pageNum }"> <input type="hidden" name="column" value="${search.column }"> <input type="hidden" name="keyword" value="${search.keyword }"> <input type="hidden" name="idx" value="${securityBoard.idx }"> <input type="hidden" name="writer" value="${securityBoard.writer }">
		<table>
			<tr>
				<td>제목</td>
