...
public class NaverLoginBean {
	...
	private static final String CLIENT_SAECRET = "2";
	...
	public String getAuthorizationUrl(HttpSession session) {
		...
		OAuth20Service oAuth20Service = new ServiceBuilder().apiKey(CLIENT_ID).callback(REDIRECT_URI).state(state)
	...
	public OAuth2AccessToken getAccessToken(HttpSession session, String code, String state) throws IOException {
		...
		OAuth20Service oAuth20Service = new ServiceBuilder().apiKey(CLIENT_ID).apiSecret(CLIENT_SAECRET)
