			...
			<td>
				...
				<table width=590 border=0 cellpadding=0 cellspacing=0>
					...
					<c:when test="${empty(loginUserinfo) }">
						...
						<form name="f" method="post">
							<table border="0" cellpadding="0" cellspacing="1" width="590" bgcolor="BBBBBB">
								<tr>
									...
									<td width=490 bgcolor="ffffff" style="padding-left: 10px;"><input type="text" style="width: 150" name="userid" value="${userid }"></td>
								</tr>
								<tr>
						...
						<table width=590 border=0 cellpadding=0 cellspacing=0>
							<tr>
								<td align=center><input type="button" value="로그인" onClick="userLogin();"> &nbsp;</td>
							</tr>
						</table>
					</c:when>
					<c:otherwise>
						...
						<table border="0" cellpadding="0" cellspacing="1" width="590" bgcolor="BBBBBB">
							<tr>
								<td align=center bgcolor="E6ECDE" height="22">${loginUserinfo.name}님, 환영합니다.</td>
							</tr>
						</table>
						<br>
						...
						<table width=590 border=0 cellpadding=0 cellspacing=0>
							<tr>
								<td align=center>
									...
									<button type="button" onclick="location.href='<c:url value="/userinfo/logout"/>';">로그아웃</button> <c:if test="${loginUserinfo.status == 9 }">
