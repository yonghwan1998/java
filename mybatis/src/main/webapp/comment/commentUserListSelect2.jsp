...
<body>
	...
	<table>
		...
		<tr>
			...
			<td>
				<%-- <a href="commentReplySelect1.jsp?commentNo=<%=commentUser.getComment().getCommentNo()%>"> --%> <%-- <a href="commentReplySelect2.jsp?commentNo=<%=commentUser.getComment().getCommentNo()%>"> --%> <a href="commentReplyUserSelect.jsp?commentNo=<%=commentUser.getComment().getCommentNo()%>"> <%=commentUser.getComment().getCommentContent()%>
			</a>
			</td>
