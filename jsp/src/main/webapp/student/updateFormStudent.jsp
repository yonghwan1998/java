	...
	<form name="studentForm">
		<table align="center" border="1" cellpadding="1" cellspacing="0" width="300">
			<tr height="40">
				...
				<td width="200" align="center"> <input type="text" name="no" value="<%=student.getNo()%>"></td>
			</tr>
			<tr height="40">
			...
			<tr height="40">
				<td width="200" colspan="2" align="center"><input type="button" value="학생변경" onclick="submitCheck();"> <input type="reset" value="초기화"> <input type="button" value="학생목록"></td>
			</tr>
		</table>
	</form>
