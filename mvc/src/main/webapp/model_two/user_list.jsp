				...
				<table border="0" cellpadding="0" cellspacing="1" width="590" bgcolor="BBBBBB">
					...
					<c:forEach var="userinfo" items="${userinfoList }">
						<tr>
							...
							<td width=200 align=center bgcolor="ffffff"><a href="<c:url value="/view.do"/>?userid=${userinfo.userid}" class="user"> ${userinfo.name } </a></td>
				...
				<table border="0" cellpadding="0" cellspacing="1" width="590">
					<tr>
						<td align="right"><c:if test="${loginUserinfo.status == 9 }">
							...
							</c:if> <input type="button" value="로그아웃" onclick="location.href='<c:url value="/logout.do"/>';" /></td>
					</tr>
				</table>
			</td>
		</tr>
